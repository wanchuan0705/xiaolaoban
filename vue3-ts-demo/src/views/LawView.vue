<template>
    <div>
        <el-form :inline="true" :model="selectData" class="demo-form-inline">
            <el-form-item label="目录">
                <el-input v-model="selectData.Directory" placeholder="请输入目录" clearable />
            </el-form-item>
            <el-form-item>
        ...
        <el-table :data="dataList.comList" border style="width: 100%">
            ...
            <el-table-column prop="Directory" label="目录" width="180" />
    ...
    <el-dialog v-model="isAddShow" title="新增信息">
        <el-form :model="active">
            <el-form-item label="目录" label-width="50px">
                <el-input v-model="active.Directory" autocomplete="off" />
            </el-form-item>
...
export default defineComponent({
    setup() {
        ...
        const getUser = async () => {
            try {
                const res = await axios.get('https://console-mock.apipost.cn/mock/e2291285-0895-4edf-95ea-855e14b04157/?apipost_id=9d0b6c');
                // 处理响应
            ...
            if (data.selectData.Directory) {
                ...
                if (data.selectData.Directory) {
                    arr = data.list.filter((value) => {
                        //将过滤出来数组赋值给arr
                        return value.Directory.indexOf(data.selectData.Directory) !== -1;
                    });
                }
            } else {
                arr = data.list;
        ...
        const updateUser = () => {
            ...
            obj.Account = data.active.Directory
            obj.Password = data.active.Content
            console.log(obj);
